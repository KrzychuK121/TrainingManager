...
import springweb.trainingmanager.models.viewmodels.Castable;
import springweb.trainingmanager.models.viewmodels.exercise.ExerciseTraining;
import springweb.trainingmanager.repositories.forcontrollers.DuplicationRepository;
...
public class NoDuplicationService {
    ...
    > E prepEntity(
        ...
        if(found.getId() != found.getDefaultId())
            return found;
